...
# ── test_risk_level.py ──────────────────────────────
cat > /opt/cas/tests/test_risk_level.py << 'PYEOF'
"""
...
PYEOF
echo "[OK] test_risk_level.py written"

# ── test_decision_engine.py ─────────────────────────
cat > /opt/cas/tests/test_decision_engine.py << 'PYEOF'
"""
...
PYEOF
echo "[OK] test_decision_engine.py written"

# ── Run full suite ───────────────────────────────────
echo ""
echo "=== Running full test suite ==="
cd /opt/cas && python3 -m pytest tests/ --tb=short 2>&1 | tail -30
